...
.hrb-form-steps {
    ...
    padding: 30px 20px;
    position: relative;
    background: linear-gradient(135deg, var(--hrb-background-light) 0%, rgba(99, 102, 241, 0.02) 100%);
...
.hrb-form-steps::before {
    ...
    right: 10%;
    height: 3px;
    background: linear-gradient(90deg, var(--hrb-border) 0%, rgba(0, 115, 170, 0.3) 50%, var(--hrb-border) 100%);
...
.hrb-step:hover .hrb-step-number::before {
    opacity: 1;
}
...
@keyframes pulse {
    ...
    50% {
        box-shadow: 0 0 0 8px rgba(99, 102, 241, 0.1), var(--hrb-shadow-lg);
    }
}
...
.hrb-step.completed .hrb-step-number {
    background: linear-gradient(135deg, var(--hrb-success) 0%, #138a13 100%);
    color: white;
    border-color: var(--hrb-success);
    box-shadow: 0 4px 16px rgba(16, 124, 16, 0.3);
}

.hrb-step.completed .hrb-step-number::after {
    content: '✓';
    font-size: 18px;
    font-weight: 900;
}
...
.hrb-form-input, .hrb-form-select, .hrb-form-control {
    width: 100%;
    padding: 16px 20px;
    border: 2px solid var(--hrb-border);
...
.hrb-form-input:hover, .hrb-form-select:hover, .hrb-form-control:hover {
    border-color: var(--hrb-primary);
...
.hrb-form-input:focus, .hrb-form-select:focus, .hrb-form-control:focus {
    outline: none;
    border-color: var(--hrb-primary);
...
.hrb-row {
    ...
    margin-left: 0 !important; /* Align with form steps */
    margin-right: 0 !important; /* Align with form steps */
}
...
.hrb-no-slots, .hrb-loading-message, .hrb-error-message {
    text-align: center;
    padding: 20px;
    border-radius: 6px;
    margin-top: 15px;
...
.hrb-step:hover .hrb-step-number {
...
.hrb-step.completed:hover .hrb-step-number {
    background: #0d5a0d;
    transform: scale(1.1);
}

.hrb-step.active:hover .hrb-step-number {
...
.hrb-step-clickable .hrb-step-number {
...
.hrb-form-input.error, .hrb-form-select.error, .hrb-form-control.error {
...
.hrb-btn:disabled, .hrb-btn[disabled] {
...
.hrb-btn:disabled:hover, .hrb-btn[disabled]:hover {
    background: #e9ecef !important;
    color: #6c757d !important;
    transform: none !important;
    box-shadow: none !important;
...
.hrb-verification-success, .hrb-alert-success {
    background: #f0fdf4 !important;
...
.hrb-verification-error, .hrb-alert-error {
    background: #fef2f2 !important;
...
<div class="hrb-container">
    <?php if ($show_room_info): ?>
    <div class="hrb-room-info hrb-mb-4">
        <div class="hrb-row">
            <div class="hrb-col-6">
                <?php if (!empty($images)): ?>
                <img src="<?php echo esc_url($images[0]); ?>" alt="<?php echo esc_attr($room->name); ?>" class="hrb-room-image">
                <?php else: ?>
                <div class="hrb-room-image-placeholder">
                    <span><?php _e('No image available', 'hourly-room-booking'); ?></span>
                </div>
                <?php endif; ?>
            </div>
            <div class="hrb-col-6">
                <h2 class="hrb-heading-md"><?php echo esc_html($room->name); ?></h2>
                <p class="hrb-text-muted"><?php echo esc_html($room->description); ?></p>
                ...
                <div class="hrb-room-details">
                    ...
                    <div class="hrb-room-detail">
                        ...
                        <?php echo hrb_format_amount($room->hourly_price); ?> <?php _e('per hour', 'hourly-room-booking'); ?>
                    </div>
                </div>

                <?php if (!empty($amenities)): ?>
                <div class="hrb-room-amenities hrb-mt-3">
                    <strong><?php _e('Amenities:', 'hourly-room-booking'); ?></strong>
                    <div class="hrb-room-features">
                        <?php foreach ($amenities as $amenity): ?>
                        <span class="hrb-room-feature"><?php echo esc_html($amenity); ?></span>
                        <?php endforeach; ?>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="hrb-form-step-content active" data-step="1">
                    ...
                    <div class="hrb-col-6">
                        <div class="hrb-form-group">
                            <label class="hrb-form-label required" for="booking-date-<?php echo $room_id; ?>">
                                <?php _e('Booking Date', 'hourly-room-booking'); ?>
                            </label>
                            <input type="date"
                                ...
                                <?php for ($hours = 2; $hours <= 12; $hours++): ?>
                                    ...
                                    if ($hours == 2 && $room->price_2_hours > 0) {
                                        ...
                                        if ($room->price_4_hours > 0) {
                                            ...
                                            if ($extra_hour_price > 0) {
                                                ...
                                                $price += $extra_hours * floatval($room->hourly_price);
                                            }
                                        }
                                    }
                                    ...
                                    if ($use_room_price) {
                                        ...
                                        if ($global_price > 0) {
                                            ...
                                            $price = floatval($room->hourly_price) * $hours;
                                        }
                                    }
                                    ?>
                ...
                <div class="hrb-form-actions">
                    <button type="button" class="hrb-btn hrb-btn-primary hrb-step-next">
                        <?php _e('Next', 'hourly-room-booking'); ?>
                    </button>
                </div>
            </div>
            ...
            <div class="hrb-form-step-content" data-step="2">
                ...
                <div class="hrb-form-group">
                    <label class="hrb-form-label" for="extra-people-<?php echo $room_id; ?>">
                        <?php _e('Additional People', 'hourly-room-booking'); ?>
                    </label>
                ...
                <div class="hrb-form-group">
                    <label class="hrb-form-label" for="special-requests-<?php echo $room_id; ?>">
                        <?php _e('Special Requests', 'hourly-room-booking'); ?>
                    </label>
                ...
                <div class="hrb-form-actions">
                    <button type="button" class="hrb-btn hrb-btn-secondary hrb-step-prev">
                        <?php _e('Previous', 'hourly-room-booking'); ?>
                    </button>
                    <button type="button" class="hrb-btn hrb-btn-primary hrb-step-next">
                        <?php _e('Next', 'hourly-room-booking'); ?>
                    </button>
...
jQuery(document).ready(function($) {
    ...
    const roomHourlyPrice = <?php echo floatval($room->hourly_price); ?>;
    ...
    function goToStep(stepNumber) {
        ...
        if (form.length && form.get(0).scrollIntoView) {
            form.get(0).scrollIntoView({ behavior: 'smooth', block: 'start' });
        }
    ...
    function displayAvailableTimeSlots(slots, roomId) {
        ...
        if (slots.length === 0) {
            ...
            slots.forEach(function(slot) {
                html += `
                    <div class="hrb-time-slot available" data-start-time="${slot.start_time}" data-end-time="${slot.end_time}">
                        <div class="hrb-time-slot-time">${slot.label}</div>
                        <div class="hrb-time-slot-status"><?php _e('Available', 'hourly-room-booking'); ?></div>
                    </div>
                `;
            });
            html += '</div>';
                        ...
                        <div class="hrb-extra-item">
                            ...
                            <div class="hrb-extra-content">
                             <input type="checkbox"
                                ...
                                <div class="hrb-extra-price">+${currencySymbol}${parseFloat(extra.price).toFixed(2)}</div>
                            </div>
                        </div>`;
                }
            });
    ...
    function calculateDurationPrice(duration) {
        const roomData = <?php echo json_encode([
            'hourly_price' => floatval($room->hourly_price),
        ...
        if (duration == 2 && roomData.price_2_hours > 0) {
            ...
            if (roomData.price_4_hours > 0) {
                ...
                if (extraHourPrice > 0) {
                    ...
                    // Fallback to hourly rate for extra hours
                    price += extraHours * roomData.hourly_price;
                }
            }
        }
        ...
        if (duration == 2) {
            ...
            if (extraHourPrice > 0) {
                ...
                // Fallback to hourly rate for extra hours
                globalPrice += extraHours * roomData.hourly_price;
            }
        }
        ...
        // Final fallback to hourly rate
        if (roomData.hourly_price > 0) {
            return roomData.hourly_price * duration;
        }
    ...
    function updateBookingSummary() {
        ...
        selectedExtras.each(function() {
            ...
            extrasPrice += price;
            extrasDetails.push(
                `<span class="hrb-extra-summary-name">${name}</span> <span class="hrb-extra-summary-price">${currencySymbol}${price.toFixed(2)}</span>`
            );
        });
        ...
        if (extraPeople > 0) {
            summaryHtml += `
                <div class="hrb-summary-item">
                    ...
                    <span>${currencySymbol}${additionalPeoplePrice.toFixed(2)}</span>
                </div>
            `;
        }
        ...
        if (paypalFee > 0 && paymentMethod === 'paypal') {
            summaryHtml += `
                <div class="hrb-summary-item hrb-summary-fee">
                    ...
                    <span>${currencySymbol}${paypalFee.toFixed(2)}</span>
                </div>
            `;
        }
